...
export function getPublicKey(data) {
  return get({
    url: `${url.ORG_LIST}/publicKey/${data.username}`,
    method: "get",
    params: null
  });
}
...
export function deletePublicKey(data) {
  return post({
    url: `${url.ORG_LIST}/publicKey/delete/${data.username}`,
    method: "post",
    data: qs.stringify(data)
  });
}
...
export function getDept(data) {
  return get({
    url: `${url.ORG_LIST}/debts/${data.username}`,
    method: "get"
  });
}
...
export function getReceipt(data) {
  return get({
    url: `${url.ORG_LIST}/receipt/${data.username}`,
    method: "get"
  });
}
...
export function getAssets(data) {
  return get({
    url: `${url.ORG_LIST}/account/${data.username}`,
    method: "get"
  });
}
