...
<template>
    <div class="key-dialog">
        ...
        <el-form :model="userForm" :rules="rules" ref="userForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="欠款数额" prop="amount" style="width: 546px">
                <el-input v-model="userForm.amount" placeholder="请输入欠款数额"></el-input>
            </el-form-item>
            <el-form-item label="还款日期" prop="date" style="width: 546px">
                <el-input v-model="userForm.date" placeholder="请输入还款日期"></el-input>
            </el-form-item>
        </el-form>
...
<script>
import { addDebt, bindUser } from "@/util/api";
